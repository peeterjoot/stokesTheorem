...
\begin{equation}\label{eqn:stokesAndGreens:20}
\int_A d^2 \Bx \cdot (\boldpartial \wedge \Bf) = \ointclockwise d\Bx \cdot \Bf.
\end{equation}

Assuming \( u, v\) parameterization
\begin{equation}\label{eqn:stokesAndGreens:40}
\begin{aligned}
\int_A d^2 \Bx \cdot (\boldpartial \wedge \Bf)
&= \int_A (d\Bx_u \wedge d\Bx_v) \cdot (\boldpartial \wedge \Bf) \\
&= \int_A ((d\Bx_u \wedge d\Bx_v) \cdot \Bx^u) \cdot \partial_u \Bf + \int_A ((d\Bx_u \wedge d\Bx_v) \cdot \Bx^v) \cdot \partial_v \Bf \\
&= -\int_A du dv \Bx_v \cdot \partial_u \Bf + \int_A du dv \Bx_u \cdot \partial_v \Bf \\
&= -\int_A du dv \Bx_v \cdot \partial_u \Bf + \int_A du dv \lr{ -\Bx_v \cdot \partial_u \Bf + \Bx_u \cdot \partial_v \Bf }.
\end{aligned}
\end{equation}

The coordinate expansion of \( \Bf \) with respect to the tangent space coordinates is
\begin{equation}\label{eqn:stokesAndGreens:60}
...
\begin{equation}\label{eqn:stokesAndGreens:80}
\begin{aligned}
...
\end{equation}
which gives
\begin{equation}\label{eqn:stokesAndGreens:100}
