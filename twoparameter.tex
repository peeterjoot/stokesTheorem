...
\begin{equation}\label{eqn:stokesTheoremCore:100}
\begin{aligned}
...
\begin{equation}\label{eqn:stokesTheoremCore:200}
\begin{aligned}
\boldpartial
...
\begin{equation}\label{eqn:stokesTheoremCore:220}
\begin{aligned}
\int_A d^2 \Bx \cdot (\boldpartial \wedge \Bf)
&=
\int_A (d^2 \Bx \cdot \boldpartial) \cdot \Bf \\
...
\begin{equation}\label{eqn:stokesTheoremCore:240}
\begin{aligned}
\int_A d^2 \Bx \cdot (\boldpartial \wedge \Bf)
&=
\int
...
\begin{equation}\label{eqn:stokesTheoremCore:260}
...
%\begin{equation}\label{eqn:stokesTheoremCore:280}
